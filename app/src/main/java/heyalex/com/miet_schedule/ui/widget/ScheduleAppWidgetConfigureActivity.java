...
public class ScheduleAppWidgetConfigureActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = ScheduleAppWidgetConfigureActivity.this;
            ...
            ScheduleAppWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId);
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAppWidgetText.setText(loadTitlePref(ScheduleAppWidgetConfigureActivity.this, mAppWidgetId));
    }
}
